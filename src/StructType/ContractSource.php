...
/**
 * This class stands for ContractSource StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:ContractSource
 * @subpackage Structs
 */
class ContractSource extends AbstractStructBase
{
    /**
     * The InternalValue
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for ContractSource
     * @uses ContractSource::setInternalValue()
     ...
     * @param int $internalValue
     * @return \Mu4ddi3\Compensa\Webservice\StructType\ContractSource
     */
