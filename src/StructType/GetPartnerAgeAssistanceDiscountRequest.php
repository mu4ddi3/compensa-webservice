...
/**
 * This class stands for GetPartnerAgeAssistanceDiscountRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetPartnerAgeAssistanceDiscountRequest
 * @subpackage Structs
 */
class GetPartnerAgeAssistanceDiscountRequest extends GetPartnerAgeDiscountRequest
{
    /**
     * The IsAcSelected
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for GetPartnerAgeAssistanceDiscountRequest
     * @uses GetPartnerAgeAssistanceDiscountRequest::setIsAcSelected()
     * @uses GetPartnerAgeAssistanceDiscountRequest::setTariffVariant()
     * @uses GetPartnerAgeAssistanceDiscountRequest::setVehicleGroupId()
     ...
     * @param bool $isAcSelected
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetPartnerAgeAssistanceDiscountRequest
     */
