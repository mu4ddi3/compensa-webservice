...
/**
 * This class stands for BaseFactorDefinition StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:BaseFactorDefinition
 * @subpackage Structs
 */
class BaseFactorDefinition extends AbstractStructBase
{
    /**
     * The Factor
     * Meta informations extracted from the WSDL
    ...
    public $Factor;
    /**
     * Constructor method for BaseFactorDefinition
     * @uses BaseFactorDefinition::setFactor()
     ...
     * @param \Mu4ddi3\Compensa\Webservice\StructType\Factor $factor
     * @return \Mu4ddi3\Compensa\Webservice\StructType\BaseFactorDefinition
     */
