...
/**
 * This class stands for PrintOfferRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:PrintOfferRequest
 * @subpackage Structs
 */
class PrintOfferRequest extends AbstractStructBase
{
    /**
     * The OfferNumber
     * Meta informations extracted from the WSDL
    ...
    public $OfferNumber;
    /**
     * Constructor method for PrintOfferRequest
     * @uses PrintOfferRequest::setOfferNumber()
     ...
     * @param int $offerNumber
     * @return \Mu4ddi3\Compensa\Webservice\StructType\PrintOfferRequest
     */
