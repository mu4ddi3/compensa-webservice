...
/**
 * This class stands for GetIsBlackRiskUnusualVehicleUsageRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetIsBlackRiskUnusualVehicleUsageRequest
 * @subpackage Structs
 */
class GetIsBlackRiskUnusualVehicleUsageRequest extends GetIsBlackRiskRequest
{
    /**
    ...
    /**
     * Constructor method for GetIsBlackRiskUnusualVehicleUsageRequest
     * @uses GetIsBlackRiskUnusualVehicleUsageRequest::setUnusualVehicleUsage()
     ...
     * @param string $unusualVehicleUsage
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetIsBlackRiskUnusualVehicleUsageRequest
     */
