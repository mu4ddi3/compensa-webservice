...
/**
 * This class stands for ResponseOfSaveApplicationResponseAwgQbKoT StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:ResponseOfSaveApplicationResponseAwgQbKoT
 * @subpackage Structs
 */
class ResponseOfSaveApplicationResponseAwgQbKoT extends AbstractStructBase
{
    /**
     * The Errors
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Mu4ddi3\Compensa\Webservice\StructType\SaveApplicationResponse
     */
    public $ResponseData;
    /**
     * The Timestamp
    ...
    public $Timestamp;
    /**
     * Constructor method for ResponseOfSaveApplicationResponseAwgQbKoT
     * @uses ResponseOfSaveApplicationResponseAwgQbKoT::setErrors()
     * @uses ResponseOfSaveApplicationResponseAwgQbKoT::setMethodName()
     * @uses ResponseOfSaveApplicationResponseAwgQbKoT::setRequestID()
     * @uses ResponseOfSaveApplicationResponseAwgQbKoT::setResponseData()
     * @uses ResponseOfSaveApplicationResponseAwgQbKoT::setTimestamp()
     * @param \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfError $errors
     * @param string $methodName
     * @param string $requestID
     * @param \Mu4ddi3\Compensa\Webservice\StructType\SaveApplicationResponse $responseData
     * @param string $timestamp
     */
    public function __construct(\Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfError $errors = null, $methodName = null, $requestID = null, \Mu4ddi3\Compensa\Webservice\StructType\SaveApplicationResponse $responseData = null, $timestamp = null)
    {
        $this
            ->setErrors($errors)
     ...
     * @param \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfError $errors
     * @return \Mu4ddi3\Compensa\Webservice\StructType\ResponseOfSaveApplicationResponseAwgQbKoT
     */
     ...
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Mu4ddi3\Compensa\Webservice\StructType\SaveApplicationResponse|null
     */
     ...
     * @return \Mu4ddi3\Compensa\Webservice\StructType\ResponseOfSaveApplicationResponseAwgQbKoT
     */
    public function setResponseData(\Mu4ddi3\Compensa\Webservice\StructType\SaveApplicationResponse $responseData = null)
    {
