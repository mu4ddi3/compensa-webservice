...
/**
 * This class stands for GetIsBlackRiskOcVehicleGroupRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetIsBlackRiskOcVehicleGroupRequest
 * @subpackage Structs
 */
class GetIsBlackRiskOcVehicleGroupRequest extends GetIsBlackRiskRequest
{
    /**
     * The VehicleGroupId
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for GetIsBlackRiskOcVehicleGroupRequest
     * @uses GetIsBlackRiskOcVehicleGroupRequest::setVehicleGroupId()
     ...
     * @param int $vehicleGroupId
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetIsBlackRiskOcVehicleGroupRequest
     */
