...
/**
 * This class stands for AssistanceInsuranceVehicleAgeBlackRiskRule StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:AssistanceInsuranceVehicleAgeBlackRiskRule
 * @subpackage Structs
 */
class AssistanceInsuranceVehicleAgeBlackRiskRule extends BlackRiskRule
{
    /**
    ...
    /**
     * Constructor method for AssistanceInsuranceVehicleAgeBlackRiskRule
     * @uses AssistanceInsuranceVehicleAgeBlackRiskRule::setVehicleAgeLeftBound()
     * @uses AssistanceInsuranceVehicleAgeBlackRiskRule::setVehicleAgeRightBound()
     ...
     * @param int $vehicleAgeLeftBound
     * @return \Mu4ddi3\Compensa\Webservice\StructType\AssistanceInsuranceVehicleAgeBlackRiskRule
     */
