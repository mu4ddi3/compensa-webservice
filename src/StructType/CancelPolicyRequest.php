...
/**
 * This class stands for CancelPolicyRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:CancelPolicyRequest
 * @subpackage Structs
 */
class CancelPolicyRequest extends AbstractStructBase
{
    /**
     * The PolicyNumber
     * Meta informations extracted from the WSDL
    ...
    public $ProductType;
    /**
     * Constructor method for CancelPolicyRequest
     * @uses CancelPolicyRequest::setPolicyNumber()
     * @uses CancelPolicyRequest::setProductType()
     ...
     * @param int $policyNumber
     * @return \Mu4ddi3\Compensa\Webservice\StructType\CancelPolicyRequest
     */
