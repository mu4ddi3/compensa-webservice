...
/**
 * This class stands for VehicleAgeRange StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:VehicleAgeRange
 * @subpackage Structs
 */
class VehicleAgeRange extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for VehicleAgeRange
     * @uses VehicleAgeRange::setVehicleAgeLeftBound()
     * @uses VehicleAgeRange::setVehicleAgeRightBound()
     ...
     * @param int $vehicleAgeLeftBound
     * @return \Mu4ddi3\Compensa\Webservice\StructType\VehicleAgeRange
     */
