...
/**
 * This class stands for VehicleAgeCorrectionFactor StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:VehicleAgeCorrectionFactor
 * @subpackage Structs
 */
class VehicleAgeCorrectionFactor extends AbstractStructBase
{
    /**
     * The Factor
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for VehicleAgeCorrectionFactor
     * @uses VehicleAgeCorrectionFactor::setFactor()
     * @uses VehicleAgeCorrectionFactor::setVehicleAgeLeftBound()
     * @uses VehicleAgeCorrectionFactor::setVehicleAgeRightBound()
     ...
     * @param \Mu4ddi3\Compensa\Webservice\StructType\Factor $factor
     * @return \Mu4ddi3\Compensa\Webservice\StructType\VehicleAgeCorrectionFactor
     */
