...
/**
 * This class stands for InsuranceCompanyDetails StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:InsuranceCompanyDetails
 * @subpackage Structs
 */
class InsuranceCompanyDetails extends AbstractStructBase
{
    /**
     * The CompanyCode
     * Meta informations extracted from the WSDL
    ...
    public $CompanyName;
    /**
     * Constructor method for InsuranceCompanyDetails
     * @uses InsuranceCompanyDetails::setCompanyCode()
     * @uses InsuranceCompanyDetails::setCompanyName()
     ...
     * @param string $companyCode
     * @return \Mu4ddi3\Compensa\Webservice\StructType\InsuranceCompanyDetails
     */
