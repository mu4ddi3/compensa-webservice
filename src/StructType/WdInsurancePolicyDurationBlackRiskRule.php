...
/**
 * This class stands for WdInsurancePolicyDurationBlackRiskRule StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:WdInsurancePolicyDurationBlackRiskRule
 * @subpackage Structs
 */
class WdInsurancePolicyDurationBlackRiskRule extends BlackRiskRule
{
    /**
     * The IsShortTerm
     * Meta informations extracted from the WSDL
    ...
    public $IsShortTerm;
    /**
     * Constructor method for WdInsurancePolicyDurationBlackRiskRule
     * @uses WdInsurancePolicyDurationBlackRiskRule::setIsShortTerm()
     ...
     * @param bool $isShortTerm
     * @return \Mu4ddi3\Compensa\Webservice\StructType\WdInsurancePolicyDurationBlackRiskRule
     */
