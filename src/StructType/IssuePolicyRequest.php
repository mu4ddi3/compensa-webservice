...
/**
 * This class stands for IssuePolicyRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:IssuePolicyRequest
 * @subpackage Structs
 */
class IssuePolicyRequest extends AbstractStructBase
{
    /**
     * The Contract
     * Meta informations extracted from the WSDL
    ...
    public $Contract;
    /**
     * Constructor method for IssuePolicyRequest
     * @uses IssuePolicyRequest::setContract()
     ...
     * @param \Mu4ddi3\Compensa\Webservice\StructType\MotorContract $contract
     * @return \Mu4ddi3\Compensa\Webservice\StructType\IssuePolicyRequest
     */
