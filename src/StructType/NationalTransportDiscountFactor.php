...
/**
 * This class stands for NationalTransportDiscountFactor StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:NationalTransportDiscountFactor
 * @subpackage Structs
 */
class NationalTransportDiscountFactor extends AbstractStructBase
{
    /**
     * The Factor
     * Meta informations extracted from the WSDL
    ...
    public $Factor;
    /**
     * Constructor method for NationalTransportDiscountFactor
     * @uses NationalTransportDiscountFactor::setFactor()
     ...
     * @param \Mu4ddi3\Compensa\Webservice\StructType\Factor $factor
     * @return \Mu4ddi3\Compensa\Webservice\StructType\NationalTransportDiscountFactor
     */
