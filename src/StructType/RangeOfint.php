...
/**
 * This class stands for RangeOfint StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:RangeOfint
 * @subpackage Structs
 */
class RangeOfint extends AbstractStructBase
{
    /**
     * The lowerBound
     * Meta informations extracted from the WSDL
    ...
    public $upperBound;
    /**
     * Constructor method for RangeOfint
     * @uses RangeOfint::setLowerBound()
     * @uses RangeOfint::setRangeType()
     * @uses RangeOfint::setUpperBound()
     ...
     * @param int $lowerBound
     * @return \Mu4ddi3\Compensa\Webservice\StructType\RangeOfint
     */
