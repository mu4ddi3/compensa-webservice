...
/**
 * This class stands for GetPkdCorrectionRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetPkdCorrectionRequest
 * @subpackage Structs
 */
class GetPkdCorrectionRequest extends AbstractStructBase
{
    /**
     * The PkdCode
     * Meta informations extracted from the WSDL
    ...
    public $PkdCode;
    /**
     * Constructor method for GetPkdCorrectionRequest
     * @uses GetPkdCorrectionRequest::setPkdCode()
     ...
     * @param string $pkdCode
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetPkdCorrectionRequest
     */
