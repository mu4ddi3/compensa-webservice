 ...
 * @subpackage Structs
 */
class Assistance extends MotorRisk
{
    /**
     ...
     * @uses Assistance::setAdditionalDiscountCode()
     * @uses Assistance::setAdditionalDiscountPercentageValue()
     * @uses Assistance::setCentralCorrectionPercentageValue()
     * @uses Assistance::setIsAdditionalDiscount()
     * @uses Assistance::setIsCentralCorrection()
     * @uses Assistance::setTariffVariant()
     ...
     * @param string $additionalDiscountCode
     * @return \Mu4ddi3\Compensa\Webservice\StructType\Assistance
     */
