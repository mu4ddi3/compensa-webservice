...
/**
 * This class stands for GetVehicleAgeCorrectionRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetVehicleAgeCorrectionRequest
 * @subpackage Structs
 */
class GetVehicleAgeCorrectionRequest extends AbstractStructBase
{
    /**
     * The VehicleAge
     * Meta informations extracted from the WSDL
    ...
    public $VehicleAge;
    /**
     * Constructor method for GetVehicleAgeCorrectionRequest
     * @uses GetVehicleAgeCorrectionRequest::setVehicleAge()
     ...
     * @param int $vehicleAge
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetVehicleAgeCorrectionRequest
     */
