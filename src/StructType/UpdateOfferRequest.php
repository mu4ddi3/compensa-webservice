...
/**
 * This class stands for UpdateOfferRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:UpdateOfferRequest
 * @subpackage Structs
 */
class UpdateOfferRequest extends AbstractStructBase
{
    /**
     * The Contract
     * Meta informations extracted from the WSDL
    ...
    public $Contract;
    /**
     * Constructor method for UpdateOfferRequest
     * @uses UpdateOfferRequest::setContract()
     ...
     * @param \Mu4ddi3\Compensa\Webservice\StructType\MotorContract $contract
     * @return \Mu4ddi3\Compensa\Webservice\StructType\UpdateOfferRequest
     */
