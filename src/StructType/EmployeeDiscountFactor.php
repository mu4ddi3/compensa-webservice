...
/**
 * This class stands for EmployeeDiscountFactor StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:EmployeeDiscountFactor
 * @subpackage Structs
 */
class EmployeeDiscountFactor extends AbstractStructBase
{
    /**
     * The Factor
     * Meta informations extracted from the WSDL
    ...
    public $Factor;
    /**
     * Constructor method for EmployeeDiscountFactor
     * @uses EmployeeDiscountFactor::setFactor()
     ...
     * @param \Mu4ddi3\Compensa\Webservice\StructType\Factor $factor
     * @return \Mu4ddi3\Compensa\Webservice\StructType\EmployeeDiscountFactor
     */
