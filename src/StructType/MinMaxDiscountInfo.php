...
/**
 * This class stands for MinMaxDiscountInfo StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:MinMaxDiscountInfo
 * @subpackage Structs
 */
class MinMaxDiscountInfo extends AbstractStructBase
{
    /**
     * The MaxFactor
     * Meta informations extracted from the WSDL
    ...
    public $MinFactor;
    /**
     * Constructor method for MinMaxDiscountInfo
     * @uses MinMaxDiscountInfo::setMaxFactor()
     * @uses MinMaxDiscountInfo::setMinFactor()
     ...
     * @param \Mu4ddi3\Compensa\Webservice\StructType\Factor $maxFactor
     * @return \Mu4ddi3\Compensa\Webservice\StructType\MinMaxDiscountInfo
     */
