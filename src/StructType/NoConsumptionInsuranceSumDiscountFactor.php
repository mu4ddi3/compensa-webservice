...
/**
 * This class stands for NoConsumptionInsuranceSumDiscountFactor StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:NoConsumptionInsuranceSumDiscountFactor
 * @subpackage Structs
 */
class NoConsumptionInsuranceSumDiscountFactor extends BaseFactorDefinition
{
    /**
     * The IsLeasing
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for NoConsumptionInsuranceSumDiscountFactor
     * @uses NoConsumptionInsuranceSumDiscountFactor::setIsLeasing()
     * @uses NoConsumptionInsuranceSumDiscountFactor::setVehicleGroupId()
     ...
     * Set IsLeasing value
     * @param bool $isLeasing
     * @return \Mu4ddi3\Compensa\Webservice\StructType\NoConsumptionInsuranceSumDiscountFactor
     */
