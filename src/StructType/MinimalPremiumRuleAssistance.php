...
/**
 * This class stands for MinimalPremiumRuleAssistance StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:MinimalPremiumRuleAssistance
 * @subpackage Structs
 */
class MinimalPremiumRuleAssistance extends MinimalPremiumRule
{
    /**
     * The IsAcSelected
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for MinimalPremiumRuleAssistance
     * @uses MinimalPremiumRuleAssistance::setIsAcSelected()
     * @uses MinimalPremiumRuleAssistance::setTariffVariant()
     ...
     * @param bool $isAcSelected
     * @return \Mu4ddi3\Compensa\Webservice\StructType\MinimalPremiumRuleAssistance
     */
