...
/**
 * This class stands for ResponseOfUpdateOfferResponseAwgQbKoT StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:ResponseOfUpdateOfferResponseAwgQbKoT
 * @subpackage Structs
 */
class ResponseOfUpdateOfferResponseAwgQbKoT extends AbstractStructBase
{
    /**
     * The Errors
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Mu4ddi3\Compensa\Webservice\StructType\UpdateOfferResponse
     */
    public $ResponseData;
    /**
     * The Timestamp
    ...
    public $Timestamp;
    /**
     * Constructor method for ResponseOfUpdateOfferResponseAwgQbKoT
     * @uses ResponseOfUpdateOfferResponseAwgQbKoT::setErrors()
     * @uses ResponseOfUpdateOfferResponseAwgQbKoT::setMethodName()
     * @uses ResponseOfUpdateOfferResponseAwgQbKoT::setRequestID()
     * @uses ResponseOfUpdateOfferResponseAwgQbKoT::setResponseData()
     * @uses ResponseOfUpdateOfferResponseAwgQbKoT::setTimestamp()
     * @param \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfError $errors
     * @param string $methodName
     * @param string $requestID
     * @param \Mu4ddi3\Compensa\Webservice\StructType\UpdateOfferResponse $responseData
     * @param string $timestamp
     */
    public function __construct(\Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfError $errors = null, $methodName = null, $requestID = null, \Mu4ddi3\Compensa\Webservice\StructType\UpdateOfferResponse $responseData = null, $timestamp = null)
    {
        $this
            ->setErrors($errors)
     ...
     * @param \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfError $errors
     * @return \Mu4ddi3\Compensa\Webservice\StructType\ResponseOfUpdateOfferResponseAwgQbKoT
     */
     ...
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Mu4ddi3\Compensa\Webservice\StructType\UpdateOfferResponse|null
     */
     ...
     * @return \Mu4ddi3\Compensa\Webservice\StructType\ResponseOfUpdateOfferResponseAwgQbKoT
     */
    public function setResponseData(\Mu4ddi3\Compensa\Webservice\StructType\UpdateOfferResponse $responseData = null)
    {
