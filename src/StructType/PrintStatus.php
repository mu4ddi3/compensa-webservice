...
/**
 * This class stands for PrintStatus StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:PrintStatus
 * @subpackage Structs
 */
class PrintStatus extends AbstractStructBase
{
    /**
     * The InternalValue
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for PrintStatus
     * @uses PrintStatus::setInternalValue()
     ...
     * @param int $internalValue
     * @return \Mu4ddi3\Compensa\Webservice\StructType\PrintStatus
     */
