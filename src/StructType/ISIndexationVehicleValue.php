...
/**
 * This class stands for ISIndexationVehicleValue StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:ISIndexationVehicleValue
 * @subpackage Structs
 */
class ISIndexationVehicleValue extends ISIndexation
{
    /**
    ...
    /**
     * Constructor method for ISIndexationVehicleValue
     * @uses ISIndexationVehicleValue::setSteeringWheelConfiguration()
     * @uses ISIndexationVehicleValue::setTariffMode()
     * @uses ISIndexationVehicleValue::setVehicleGroupId()
     * @uses ISIndexationVehicleValue::setVehicleImportStatus()
     ...
     * @param string $steeringWheelConfiguration
     * @return \Mu4ddi3\Compensa\Webservice\StructType\ISIndexationVehicleValue
     */
