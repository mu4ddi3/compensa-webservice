...
/**
 * This class stands for ContractSender StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:ContractSender
 * @subpackage Structs
 */
class ContractSender extends AbstractStructBase
{
    /**
     * The InternalValue
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for ContractSender
     * @uses ContractSender::setInternalValue()
     ...
     * @param int $internalValue
     * @return \Mu4ddi3\Compensa\Webservice\StructType\ContractSender
     */
