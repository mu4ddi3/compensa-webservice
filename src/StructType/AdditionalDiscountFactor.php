...
/**
 * This class stands for AdditionalDiscountFactor StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:AdditionalDiscountFactor
 * @subpackage Structs
 */
class AdditionalDiscountFactor extends AbstractStructBase
{
    /**
     * The MaxFactor
     * Meta informations extracted from the WSDL
    ...
    public $MinFactor;
    /**
     * Constructor method for AdditionalDiscountFactor
     * @uses AdditionalDiscountFactor::setMaxFactor()
     * @uses AdditionalDiscountFactor::setMinFactor()
     ...
     * @param \Mu4ddi3\Compensa\Webservice\StructType\Factor $maxFactor
     * @return \Mu4ddi3\Compensa\Webservice\StructType\AdditionalDiscountFactor
     */
