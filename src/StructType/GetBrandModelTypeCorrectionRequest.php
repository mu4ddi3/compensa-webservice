...
/**
 * This class stands for GetBrandModelTypeCorrectionRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetBrandModelTypeCorrectionRequest
 * @subpackage Structs
 */
class GetBrandModelTypeCorrectionRequest extends AbstractStructBase
{
    /**
     * The BrandId
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for GetBrandModelTypeCorrectionRequest
     * @uses GetBrandModelTypeCorrectionRequest::setBrandId()
     * @uses GetBrandModelTypeCorrectionRequest::setModelTypeId()
     * @uses GetBrandModelTypeCorrectionRequest::setVehicleGroupId()
     * @param int $brandId
     ...
     * Set BrandId value
     * @param int $brandId
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetBrandModelTypeCorrectionRequest
     */
