...
/**
 * This class stands for UnderwriterDiscountFactor StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:UnderwriterDiscountFactor
 * @subpackage Structs
 */
class UnderwriterDiscountFactor extends AbstractStructBase
{
    /**
     * The MaxFactor
     * Meta informations extracted from the WSDL
    ...
    public $MinFactor;
    /**
     * Constructor method for UnderwriterDiscountFactor
     * @uses UnderwriterDiscountFactor::setMaxFactor()
     * @uses UnderwriterDiscountFactor::setMinFactor()
     ...
     * @param \Mu4ddi3\Compensa\Webservice\StructType\Factor $maxFactor
     * @return \Mu4ddi3\Compensa\Webservice\StructType\UnderwriterDiscountFactor
     */
