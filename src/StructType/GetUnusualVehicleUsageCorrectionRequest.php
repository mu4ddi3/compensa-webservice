...
/**
 * This class stands for GetUnusualVehicleUsageCorrectionRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetUnusualVehicleUsageCorrectionRequest
 * @subpackage Structs
 */
class GetUnusualVehicleUsageCorrectionRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for GetUnusualVehicleUsageCorrectionRequest
     * @uses GetUnusualVehicleUsageCorrectionRequest::setUnusualVehicleUsage()
     ...
     * @param string $unusualVehicleUsage
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetUnusualVehicleUsageCorrectionRequest
     */
