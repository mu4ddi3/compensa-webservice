...
/**
 * This class stands for ObjectEnum StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:ObjectEnum
 * @subpackage Structs
 */
class ObjectEnum extends AbstractStructBase
{
    /**
     * The InternalValue
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for ObjectEnum
     * @uses ObjectEnum::setInternalValue()
     ...
     * @param int $internalValue
     * @return \Mu4ddi3\Compensa\Webservice\StructType\ObjectEnum
     */
