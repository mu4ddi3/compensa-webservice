...
/**
 * This class stands for CentralBlackRiskRule StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:CentralBlackRiskRule
 * @subpackage Structs
 */
class CentralBlackRiskRule extends BlackRiskRule
{
    /**
     * The RiskCode
     * Meta informations extracted from the WSDL
    ...
    public $RiskCode;
    /**
     * Constructor method for CentralBlackRiskRule
     * @uses CentralBlackRiskRule::setRiskCode()
     ...
     * @param string $riskCode
     * @return \Mu4ddi3\Compensa\Webservice\StructType\CentralBlackRiskRule
     */
