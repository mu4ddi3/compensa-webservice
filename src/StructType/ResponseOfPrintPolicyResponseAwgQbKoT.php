...
/**
 * This class stands for ResponseOfPrintPolicyResponseAwgQbKoT StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:ResponseOfPrintPolicyResponseAwgQbKoT
 * @subpackage Structs
 */
class ResponseOfPrintPolicyResponseAwgQbKoT extends AbstractStructBase
{
    /**
     * The Errors
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Mu4ddi3\Compensa\Webservice\StructType\PrintPolicyResponse
     */
    public $ResponseData;
    /**
     * The Timestamp
    ...
    public $Timestamp;
    /**
     * Constructor method for ResponseOfPrintPolicyResponseAwgQbKoT
     * @uses ResponseOfPrintPolicyResponseAwgQbKoT::setErrors()
     * @uses ResponseOfPrintPolicyResponseAwgQbKoT::setMethodName()
     * @uses ResponseOfPrintPolicyResponseAwgQbKoT::setRequestID()
     * @uses ResponseOfPrintPolicyResponseAwgQbKoT::setResponseData()
     * @uses ResponseOfPrintPolicyResponseAwgQbKoT::setTimestamp()
     * @param \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfError $errors
     * @param string $methodName
     * @param string $requestID
     * @param \Mu4ddi3\Compensa\Webservice\StructType\PrintPolicyResponse $responseData
     * @param string $timestamp
     */
    public function __construct(\Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfError $errors = null, $methodName = null, $requestID = null, \Mu4ddi3\Compensa\Webservice\StructType\PrintPolicyResponse $responseData = null, $timestamp = null)
    {
        $this
            ->setErrors($errors)
     ...
     * @param \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfError $errors
     * @return \Mu4ddi3\Compensa\Webservice\StructType\ResponseOfPrintPolicyResponseAwgQbKoT
     */
     ...
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Mu4ddi3\Compensa\Webservice\StructType\PrintPolicyResponse|null
     */
     ...
     * @return \Mu4ddi3\Compensa\Webservice\StructType\ResponseOfPrintPolicyResponseAwgQbKoT
     */
    public function setResponseData(\Mu4ddi3\Compensa\Webservice\StructType\PrintPolicyResponse $responseData = null)
    {
