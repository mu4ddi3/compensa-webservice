...
/**
 * This class stands for ContractStatus StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:ContractStatus
 * @subpackage Structs
 */
class ContractStatus extends AbstractStructBase
{
    /**
     * The InternalValue
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for ContractStatus
     * @uses ContractStatus::setInternalValue()
     ...
     * @param int $internalValue
     * @return \Mu4ddi3\Compensa\Webservice\StructType\ContractStatus
     */
