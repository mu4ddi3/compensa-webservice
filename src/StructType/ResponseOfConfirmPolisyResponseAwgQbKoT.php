...
/**
 * This class stands for ResponseOfConfirmPolisyResponseAwgQbKoT StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:ResponseOfConfirmPolisyResponseAwgQbKoT
 * @subpackage Structs
 */
class ResponseOfConfirmPolisyResponseAwgQbKoT extends AbstractStructBase
{
    /**
     * The Errors
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Mu4ddi3\Compensa\Webservice\StructType\ConfirmPolisyResponse
     */
    public $ResponseData;
    /**
     * The Timestamp
    ...
    public $Timestamp;
    /**
     * Constructor method for ResponseOfConfirmPolisyResponseAwgQbKoT
     * @uses ResponseOfConfirmPolisyResponseAwgQbKoT::setErrors()
     * @uses ResponseOfConfirmPolisyResponseAwgQbKoT::setMethodName()
     * @uses ResponseOfConfirmPolisyResponseAwgQbKoT::setRequestID()
     * @uses ResponseOfConfirmPolisyResponseAwgQbKoT::setResponseData()
     * @uses ResponseOfConfirmPolisyResponseAwgQbKoT::setTimestamp()
     * @param \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfError $errors
     * @param string $methodName
     * @param string $requestID
     * @param \Mu4ddi3\Compensa\Webservice\StructType\ConfirmPolisyResponse $responseData
     * @param string $timestamp
     */
    public function __construct(\Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfError $errors = null, $methodName = null, $requestID = null, \Mu4ddi3\Compensa\Webservice\StructType\ConfirmPolisyResponse $responseData = null, $timestamp = null)
    {
        $this
            ->setErrors($errors)
     ...
     * @param \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfError $errors
     * @return \Mu4ddi3\Compensa\Webservice\StructType\ResponseOfConfirmPolisyResponseAwgQbKoT
     */
     ...
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Mu4ddi3\Compensa\Webservice\StructType\ConfirmPolisyResponse|null
     */
     ...
     * @return \Mu4ddi3\Compensa\Webservice\StructType\ResponseOfConfirmPolisyResponseAwgQbKoT
     */
    public function setResponseData(\Mu4ddi3\Compensa\Webservice\StructType\ConfirmPolisyResponse $responseData = null)
    {
