...
/**
 * This class stands for GetIsBlackRiskAcVehicleGroupRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetIsBlackRiskAcVehicleGroupRequest
 * @subpackage Structs
 */
class GetIsBlackRiskAcVehicleGroupRequest extends GetIsBlackRiskRequest
{
    /**
     * The VehicleGroupId
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for GetIsBlackRiskAcVehicleGroupRequest
     * @uses GetIsBlackRiskAcVehicleGroupRequest::setVehicleGroupId()
     ...
     * @param int $vehicleGroupId
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetIsBlackRiskAcVehicleGroupRequest
     */
