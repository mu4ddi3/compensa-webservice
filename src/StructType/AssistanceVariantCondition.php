...
/**
 * This class stands for AssistanceVariantCondition StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:AssistanceVariantCondition
 * @subpackage Structs
 */
class AssistanceVariantCondition extends AvailabilityConditionBase
{
    /**
     * The RiskVariants
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfVariantCalculationAssistance
     */
    public $AssistanceVariants;
    /**
     * Constructor method for AssistanceVariantCondition
     * @uses AssistanceVariantCondition::setRiskVariants()
     * @uses AssistanceVariantCondition::setAssistanceVariants()
     * @param \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfRiskVariant $riskVariants
     * @param \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfVariantCalculationAssistance $assistanceVariants
     */
    public function __construct(\Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfRiskVariant $riskVariants = null, \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfVariantCalculationAssistance $assistanceVariants = null)
    {
        $this
     ...
     * @param \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfRiskVariant $riskVariants
     * @return \Mu4ddi3\Compensa\Webservice\StructType\AssistanceVariantCondition
     */
     ...
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfVariantCalculationAssistance|null
     */
     ...
     * @return \Mu4ddi3\Compensa\Webservice\StructType\AssistanceVariantCondition
     */
    public function setAssistanceVariants(\Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfVariantCalculationAssistance $assistanceVariants = null)
    {
