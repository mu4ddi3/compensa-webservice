...
/**
 * This class stands for CessionaryType StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:CessionaryType
 * @subpackage Structs
 */
class CessionaryType extends AbstractStructBase
{
    /**
     * The InternalValue
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for CessionaryType
     * @uses CessionaryType::setInternalValue()
     ...
     * @param int $internalValue
     * @return \Mu4ddi3\Compensa\Webservice\StructType\CessionaryType
     */
