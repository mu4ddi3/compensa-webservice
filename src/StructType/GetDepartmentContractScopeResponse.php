...
/**
 * This class stands for GetDepartmentContractScopeResponse StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetDepartmentContractScopeResponse
 * @subpackage Structs
 */
class GetDepartmentContractScopeResponse extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for GetDepartmentContractScopeResponse
     * @uses GetDepartmentContractScopeResponse::setDepartmentContractScope()
     * @param string $departmentContractScope
     */
    public function __construct($departmentContractScope = null)
    {
        $this
     ...
     * @param string $departmentContractScope
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetDepartmentContractScopeResponse
     */
