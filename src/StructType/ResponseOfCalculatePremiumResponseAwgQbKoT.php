...
/**
 * This class stands for ResponseOfCalculatePremiumResponseAwgQbKoT StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:ResponseOfCalculatePremiumResponseAwgQbKoT
 * @subpackage Structs
 */
class ResponseOfCalculatePremiumResponseAwgQbKoT extends AbstractStructBase
{
    /**
     * The Errors
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Mu4ddi3\Compensa\Webservice\StructType\CalculatePremiumResponse
     */
    public $ResponseData;
    /**
     * The Timestamp
    ...
    public $Timestamp;
    /**
     * Constructor method for ResponseOfCalculatePremiumResponseAwgQbKoT
     * @uses ResponseOfCalculatePremiumResponseAwgQbKoT::setErrors()
     * @uses ResponseOfCalculatePremiumResponseAwgQbKoT::setMethodName()
     * @uses ResponseOfCalculatePremiumResponseAwgQbKoT::setRequestID()
     * @uses ResponseOfCalculatePremiumResponseAwgQbKoT::setResponseData()
     * @uses ResponseOfCalculatePremiumResponseAwgQbKoT::setTimestamp()
     * @param \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfError $errors
     * @param string $methodName
     * @param string $requestID
     * @param \Mu4ddi3\Compensa\Webservice\StructType\CalculatePremiumResponse $responseData
     * @param string $timestamp
     */
    public function __construct(\Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfError $errors = null, $methodName = null, $requestID = null, \Mu4ddi3\Compensa\Webservice\StructType\CalculatePremiumResponse $responseData = null, $timestamp = null)
    {
        $this
            ->setErrors($errors)
     ...
     * @param \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfError $errors
     * @return \Mu4ddi3\Compensa\Webservice\StructType\ResponseOfCalculatePremiumResponseAwgQbKoT
     */
     ...
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Mu4ddi3\Compensa\Webservice\StructType\CalculatePremiumResponse|null
     */
     ...
     * @return \Mu4ddi3\Compensa\Webservice\StructType\ResponseOfCalculatePremiumResponseAwgQbKoT
     */
    public function setResponseData(\Mu4ddi3\Compensa\Webservice\StructType\CalculatePremiumResponse $responseData = null)
    {
