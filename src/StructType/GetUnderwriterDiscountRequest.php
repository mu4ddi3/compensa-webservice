...
/**
 * This class stands for GetUnderwriterDiscountRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetUnderwriterDiscountRequest
 * @subpackage Structs
 */
class GetUnderwriterDiscountRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for GetUnderwriterDiscountRequest
     * @uses GetUnderwriterDiscountRequest::setPercentageDiscountValue()
     ...
     * @param int $percentageDiscountValue
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetUnderwriterDiscountRequest
     */
