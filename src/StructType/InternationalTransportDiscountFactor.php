...
/**
 * This class stands for InternationalTransportDiscountFactor StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:InternationalTransportDiscountFactor
 * @subpackage Structs
 */
class InternationalTransportDiscountFactor extends AbstractStructBase
{
    /**
     * The Factor
     * Meta informations extracted from the WSDL
    ...
    public $Factor;
    /**
     * Constructor method for InternationalTransportDiscountFactor
     * @uses InternationalTransportDiscountFactor::setFactor()
     ...
     * @param \Mu4ddi3\Compensa\Webservice\StructType\Factor $factor
     * @return \Mu4ddi3\Compensa\Webservice\StructType\InternationalTransportDiscountFactor
     */
