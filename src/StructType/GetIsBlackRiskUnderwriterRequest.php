...
/**
 * This class stands for GetIsBlackRiskUnderwriterRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetIsBlackRiskUnderwriterRequest
 * @subpackage Structs
 */
class GetIsBlackRiskUnderwriterRequest extends GetIsBlackRiskRequest
{
    /**
     * The RiskCode
     * Meta informations extracted from the WSDL
    ...
    public $RiskCode;
    /**
     * Constructor method for GetIsBlackRiskUnderwriterRequest
     * @uses GetIsBlackRiskUnderwriterRequest::setRiskCode()
     * @param string $riskCode
     */
    public function __construct($riskCode = null)
    {
        $this
     ...
     * @param string $riskCode
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetIsBlackRiskUnderwriterRequest
     */
