...
/**
 * This class stands for GetShortTermFactorResponse StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetShortTermFactorResponse
 * @subpackage Structs
 */
class GetShortTermFactorResponse extends AbstractStructBase
{
    /**
     * The Factor
     * Meta informations extracted from the WSDL
    ...
    public $Factor;
    /**
     * Constructor method for GetShortTermFactorResponse
     * @uses GetShortTermFactorResponse::setFactor()
     ...
     * @param \Mu4ddi3\Compensa\Webservice\StructType\Factor $factor
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetShortTermFactorResponse
     */
