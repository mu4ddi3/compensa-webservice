...
/**
 * This class stands for PrintPolicyRequest StructType
...
class PrintPolicyRequest extends AbstractStructBase
{
     ...
     * @uses PrintPolicyRequest::setPolicyNumber()
     * @uses PrintPolicyRequest::setProductType()
     ...
     * @param int $policyNumber
     * @return \Mu4ddi3\Compensa\Webservice\StructType\PrintPolicyRequest
     */
