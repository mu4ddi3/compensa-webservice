...
/**
 * This class stands for BusinessVariantIIDiscountFactor StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:BusinessVariantIIDiscountFactor
 * @subpackage Structs
 */
class BusinessVariantIIDiscountFactor extends AbstractStructBase
{
    /**
     * The Factor
     * Meta informations extracted from the WSDL
    ...
    public $Factor;
    /**
     * Constructor method for BusinessVariantIIDiscountFactor
     * @uses BusinessVariantIIDiscountFactor::setFactor()
     ...
     * @param \Mu4ddi3\Compensa\Webservice\StructType\Factor $factor
     * @return \Mu4ddi3\Compensa\Webservice\StructType\BusinessVariantIIDiscountFactor
     */
