...
/**
 * This class stands for BurglaryRisk StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:BurglaryRisk
 * @subpackage Structs
 */
class BurglaryRisk extends MyBusinessRisk
{
    /**
    ...
    /**
     * Constructor method for BurglaryRisk
     * @uses BurglaryRisk::setInsuranceSumType()
     * @uses BurglaryRisk::setInsuranceSystem()
     ...
     * @param \Mu4ddi3\Compensa\Webservice\StructType\InsuranceSumType $insuranceSumType
     * @return \Mu4ddi3\Compensa\Webservice\StructType\BurglaryRisk
     */
