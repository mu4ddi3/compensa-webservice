...
/**
 * This class stands for SaveOfferRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:SaveOfferRequest
 * @subpackage Structs
 */
class SaveOfferRequest extends AbstractStructBase
{
    /**
     * The Contract
     * Meta informations extracted from the WSDL
    ...
    public $Contract;
    /**
     * Constructor method for SaveOfferRequest
     * @uses SaveOfferRequest::setContract()
     ...
     * @param \Mu4ddi3\Compensa\Webservice\StructType\MotorContract $contract
     * @return \Mu4ddi3\Compensa\Webservice\StructType\SaveOfferRequest
     */
