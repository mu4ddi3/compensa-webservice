...
/**
 * This class stands for GetBasicRateRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetBasicRateRequest
 * @subpackage Structs
 */
class GetBasicRateRequest extends AbstractStructBase
{
    /**
     * The TariffMode
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for GetBasicRateRequest
     * @uses GetBasicRateRequest::setTariffMode()
     * @uses GetBasicRateRequest::setVehicleGroupId()
     ...
     * @param string $tariffMode
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetBasicRateRequest
     */
