...
/**
 * This class stands for IssuePolicy StructType
 * @subpackage Structs
 */
class IssuePolicy extends AbstractStructBase
{
    /**
     * The request
    ...
    public $request;
    /**
     * Constructor method for IssuePolicy
     * @uses IssuePolicy::setRequest()
     ...
     * @param \Mu4ddi3\Compensa\Webservice\StructType\RequestOfIssuePolicyRequestvm2CbLAl $request
     * @return \Mu4ddi3\Compensa\Webservice\StructType\IssuePolicy
     */
