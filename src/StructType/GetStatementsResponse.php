...
class GetStatementsResponse extends AbstractStructBase
{
     ...
     * @uses GetStatementsResponse::setStatements()
     * @param \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfStatement $statements
     */
    public function __construct(\Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfStatement $statements = null)
    {
        $this
     ...
     * @param \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfStatement $statements
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetStatementsResponse
     */
