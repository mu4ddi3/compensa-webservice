...
/**
 * This class stands for GetClaimSettlementVariantDiscountRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetClaimSettlementVariantDiscountRequest
 * @subpackage Structs
 */
class GetClaimSettlementVariantDiscountRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for GetClaimSettlementVariantDiscountRequest
     * @uses GetClaimSettlementVariantDiscountRequest::setClaimSettlementVariant()
     ...
     * @param string $claimSettlementVariant
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetClaimSettlementVariantDiscountRequest
     */
