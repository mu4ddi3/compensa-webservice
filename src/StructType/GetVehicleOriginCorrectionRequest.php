...
/**
 * This class stands for GetVehicleOriginCorrectionRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetVehicleOriginCorrectionRequest
 * @subpackage Structs
 */
class GetVehicleOriginCorrectionRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for GetVehicleOriginCorrectionRequest
     * @uses GetVehicleOriginCorrectionRequest::setSteeringWheelConfiguration()
     * @uses GetVehicleOriginCorrectionRequest::setTariffMode()
     * @uses GetVehicleOriginCorrectionRequest::setVehicleGroupId()
     * @uses GetVehicleOriginCorrectionRequest::setVehicleImportStatus()
     ...
     * @param string $steeringWheelConfiguration
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetVehicleOriginCorrectionRequest
     */
