...
/**
 * This class stands for PackageElementOptionOfTariffVariantsJ8QtxhS2 StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:PackageElementOptionOfTariffVariantsJ8QtxhS2
 * @subpackage Structs
 */
class PackageElementOptionOfTariffVariantsJ8QtxhS2 extends AbstractStructBase
{
    /**
     * The ElementValue
     * Meta informations extracted from the WSDL
    ...
    public $Option;
    /**
     * Constructor method for PackageElementOptionOfTariffVariantsJ8QtxhS2
     * @uses PackageElementOptionOfTariffVariantsJ8QtxhS2::setElementValue()
     * @uses PackageElementOptionOfTariffVariantsJ8QtxhS2::setOption()
     ...
     * @param string $elementValue
     * @return \Mu4ddi3\Compensa\Webservice\StructType\PackageElementOptionOfTariffVariantsJ8QtxhS2
     */
    public function setElementValue($elementValue = null)
    {
        // validation for constraint: enumeration
        if (!\Mu4ddi3\Compensa\Webservice\EnumType\TariffVariants::valueIsValid($elementValue)) {
            throw new \InvalidArgumentException(sprintf('Value "%s" is invalid, please use one of: %s', $elementValue, implode(', ', \Mu4ddi3\Compensa\Webservice\EnumType\TariffVariants::getValidValues())), __LINE__);
        }
