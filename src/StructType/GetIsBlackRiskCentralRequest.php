...
/**
 * This class stands for GetIsBlackRiskCentralRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetIsBlackRiskCentralRequest
 * @subpackage Structs
 */
class GetIsBlackRiskCentralRequest extends GetIsBlackRiskRequest
{
    /**
     * The RiskCode
     * Meta informations extracted from the WSDL
    ...
    public $RiskCode;
    /**
     * Constructor method for GetIsBlackRiskCentralRequest
     * @uses GetIsBlackRiskCentralRequest::setRiskCode()
     ...
     * @param string $riskCode
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetIsBlackRiskCentralRequest
     */
