...
/**
 * This class stands for ResponseOfIssuePolicyResponseAwgQbKoT StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:ResponseOfIssuePolicyResponseAwgQbKoT
 * @subpackage Structs
 */
class ResponseOfIssuePolicyResponseAwgQbKoT extends AbstractStructBase
{
    /**
     * The Errors
     * Meta informations extracted from the WSDL
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \Mu4ddi3\Compensa\Webservice\StructType\IssuePolicyResponse
     */
    public $ResponseData;
    /**
     * The Timestamp
    ...
    public $Timestamp;
    /**
     * Constructor method for ResponseOfIssuePolicyResponseAwgQbKoT
     * @uses ResponseOfIssuePolicyResponseAwgQbKoT::setErrors()
     * @uses ResponseOfIssuePolicyResponseAwgQbKoT::setMethodName()
     * @uses ResponseOfIssuePolicyResponseAwgQbKoT::setRequestID()
     * @uses ResponseOfIssuePolicyResponseAwgQbKoT::setResponseData()
     * @uses ResponseOfIssuePolicyResponseAwgQbKoT::setTimestamp()
     * @param \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfError $errors
     * @param string $methodName
     * @param string $requestID
     * @param \Mu4ddi3\Compensa\Webservice\StructType\IssuePolicyResponse $responseData
     * @param string $timestamp
     */
    public function __construct(\Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfError $errors = null, $methodName = null, $requestID = null, \Mu4ddi3\Compensa\Webservice\StructType\IssuePolicyResponse $responseData = null, $timestamp = null)
    {
        $this
            ->setErrors($errors)
     ...
     * @param \Mu4ddi3\Compensa\Webservice\ArrayType\ArrayOfError $errors
     * @return \Mu4ddi3\Compensa\Webservice\StructType\ResponseOfIssuePolicyResponseAwgQbKoT
     */
     ...
     * this property may have been unset before, due to the fact that this property is
     * removable from the request (nillable=true+minOccurs=0)
     * @return \Mu4ddi3\Compensa\Webservice\StructType\IssuePolicyResponse|null
     */
     ...
     * @return \Mu4ddi3\Compensa\Webservice\StructType\ResponseOfIssuePolicyResponseAwgQbKoT
     */
    public function setResponseData(\Mu4ddi3\Compensa\Webservice\StructType\IssuePolicyResponse $responseData = null)
    {
