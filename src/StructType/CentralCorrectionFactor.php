...
/**
 * This class stands for CentralCorrectionFactor StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:CentralCorrectionFactor
 * @subpackage Structs
 */
class CentralCorrectionFactor extends AbstractStructBase
{
    /**
     * The MaxFactor
     * Meta informations extracted from the WSDL
    ...
    public $MinFactor;
    /**
     * Constructor method for CentralCorrectionFactor
     * @uses CentralCorrectionFactor::setMaxFactor()
     * @uses CentralCorrectionFactor::setMinFactor()
     ...
     * @param \Mu4ddi3\Compensa\Webservice\StructType\Factor $maxFactor
     * @return \Mu4ddi3\Compensa\Webservice\StructType\CentralCorrectionFactor
     */
