...
/**
 * This class stands for OpContinuationData StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:OpContinuationData
 * @subpackage Structs
 */
class OpContinuationData extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for OpContinuationData
     * @uses OpContinuationData::setPreviousPolicyId()
     * @uses OpContinuationData::setPreviousProductType()
     * @param int $previousPolicyId
     * @param string $previousProductType
     */
    public function __construct($previousPolicyId = null, $previousProductType = null)
    {
        $this
     ...
     * @param int $previousPolicyId
     * @return \Mu4ddi3\Compensa\Webservice\StructType\OpContinuationData
     */
