...
/**
 * This class stands for GetIsBlackRiskAcLeasingRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetIsBlackRiskAcLeasingRequest
 * @subpackage Structs
 */
class GetIsBlackRiskAcLeasingRequest extends GetIsBlackRiskRequest
{
    /**
     * The CompanyCode
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for GetIsBlackRiskAcLeasingRequest
     * @uses GetIsBlackRiskAcLeasingRequest::setCompanyCode()
     * @uses GetIsBlackRiskAcLeasingRequest::setIsContinuation()
     ...
     * @param string $companyCode
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetIsBlackRiskAcLeasingRequest
     */
