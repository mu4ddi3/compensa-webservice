...
/**
 * This class stands for AcContinuationData StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:AcContinuationData
 * @subpackage Structs
 */
class AcContinuationData extends AbstractStructBase
{
    /**
     * The IsAcContinued
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for AcContinuationData
     * @uses AcContinuationData::setIsAcContinued()
     * @uses AcContinuationData::setPreviousPolicyId()
     * @uses AcContinuationData::setPreviousProductType()
     * @param bool $isAcContinued
     * @param int $previousPolicyId
     * @param string $previousProductType
     */
    public function __construct($isAcContinued = null, $previousPolicyId = null, $previousProductType = null)
    {
        $this
            ->setIsAcContinued($isAcContinued)
            ->setPreviousPolicyId($previousPolicyId)
            ->setPreviousProductType($previousProductType);
    }
    /**
     * Get IsAcContinued value
     * @return bool|null
     */
    public function getIsAcContinued()
    {
        return $this->IsAcContinued;
    }
    /**
     * Set IsAcContinued value
     * @param bool $isAcContinued
     * @return \Mu4ddi3\Compensa\Webservice\StructType\AcContinuationData
     */
    public function setIsAcContinued($isAcContinued = null)
    {
        // validation for constraint: boolean
        if (!is_null($isAcContinued) && !is_bool($isAcContinued)) {
            throw new \InvalidArgumentException(sprintf('Invalid value, please provide a bool, "%s" given', gettype($isAcContinued)), __LINE__);
        }
        $this->IsAcContinued = $isAcContinued;
        return $this;
    }
    /**
