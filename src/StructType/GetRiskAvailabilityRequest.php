...
/**
 * This class stands for GetRiskAvailabilityRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetRiskAvailabilityRequest
 * @subpackage Structs
 */
class GetRiskAvailabilityRequest extends AbstractStructBase
{
    /**
     * The VehicleGroupId
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for GetRiskAvailabilityRequest
     * @uses GetRiskAvailabilityRequest::setVehicleGroupId()
     ...
     * @param int $vehicleGroupId
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetRiskAvailabilityRequest
     */
