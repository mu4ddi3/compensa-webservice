...
/**
 * This class stands for CompensaRodzinaPolicyInfo StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:CompensaRodzinaPolicyInfo
 * @subpackage Structs
 */
class CompensaRodzinaPolicyInfo extends AbstractStructBase
{
    /**
     * The ManuallyAdded
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for CompensaRodzinaPolicyInfo
     * @uses CompensaRodzinaPolicyInfo::setManuallyAdded()
     * @uses CompensaRodzinaPolicyInfo::setPolicyId()
     * @uses CompensaRodzinaPolicyInfo::setProductTypeId()
     ...
     * @param bool $manuallyAdded
     * @return \Mu4ddi3\Compensa\Webservice\StructType\CompensaRodzinaPolicyInfo
     */
