...
/**
 * This class stands for GetDepartmentDirectorDiscountRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetDepartmentDirectorDiscountRequest
 * @subpackage Structs
 */
class GetDepartmentDirectorDiscountRequest extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for GetDepartmentDirectorDiscountRequest
     * @uses GetDepartmentDirectorDiscountRequest::setPercentageDiscountValue()
     ...
     * @param int $percentageDiscountValue
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetDepartmentDirectorDiscountRequest
     */
