...
/**
 * This class stands for CarUsageCategory StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:CarUsageCategory
 * @subpackage Structs
 */
class CarUsageCategory extends AbstractStructBase
{
    /**
     * The InternalValue
     * Meta informations extracted from the WSDL
    ...
    /**
     * Constructor method for CarUsageCategory
     * @uses CarUsageCategory::setInternalValue()
     ...
     * @param int $internalValue
     * @return \Mu4ddi3\Compensa\Webservice\StructType\CarUsageCategory
     */
