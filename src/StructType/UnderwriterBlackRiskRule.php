...
/**
 * This class stands for UnderwriterBlackRiskRule StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:UnderwriterBlackRiskRule
 * @subpackage Structs
 */
class UnderwriterBlackRiskRule extends BlackRiskRule
{
    /**
     * The RiskCode
     * Meta informations extracted from the WSDL
    ...
    public $RiskCode;
    /**
     * Constructor method for UnderwriterBlackRiskRule
     * @uses UnderwriterBlackRiskRule::setRiskCode()
     ...
     * @param string $riskCode
     * @return \Mu4ddi3\Compensa\Webservice\StructType\UnderwriterBlackRiskRule
     */
