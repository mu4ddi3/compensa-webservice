...
/**
 * This class stands for GetZoneSourceRequest StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:GetZoneSourceRequest
 * @subpackage Structs
 */
class GetZoneSourceRequest extends AbstractStructBase
{
    /**
     * The Contract
     * Meta informations extracted from the WSDL
    ...
    public $Contract;
    /**
     * Constructor method for GetZoneSourceRequest
     * @uses GetZoneSourceRequest::setContract()
     ...
     * @param \Mu4ddi3\Compensa\Webservice\StructType\MotorContract $contract
     * @return \Mu4ddi3\Compensa\Webservice\StructType\GetZoneSourceRequest
     */
