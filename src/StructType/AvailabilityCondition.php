...
/**
 * This class stands for AvailabilityCondition StructType
 * Meta informations extracted from the WSDL
 * - nillable: true
 * - type: tns:AvailabilityCondition
 * @subpackage Structs
 */
class AvailabilityCondition extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for AvailabilityCondition
     * @uses AvailabilityCondition::setAvaliabilityFilterLevel()
     ...
     * @param string $avaliabilityFilterLevel
     * @return \Mu4ddi3\Compensa\Webservice\StructType\AvailabilityCondition
     */
